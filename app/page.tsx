...
export default function Home() {
  return (
    ...
    </Head><main className="flex min-h-screen flex-col items-center justify-center p-24 bg-gradient-to-b from-sky-200 to-blue-200 dark:from-sky-900 dark:to-[#0141ff]">
        <Image
          src="/portafolio2.png"
